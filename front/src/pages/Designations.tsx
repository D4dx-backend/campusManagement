            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {designations.map(designation => (
                  <tr key={designation._id} className="border-b hover:bg-muted/50 transition-colors">
                    <td className="p-4 font-medium">{designation.name}</td>
                    <td className="p-4 text-sm text-muted-foreground">{designation.description || 'N/A'}</td>
                    <td className="p-4">
